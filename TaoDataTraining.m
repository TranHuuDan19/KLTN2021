...
for k=3:length(imageTrainingLabel{1,1})
    ...
    for i=1:size(imageFaceDetect,1)
        sizeImageFaceDetect = imageFaceDetect(i,3)*BB(i,4);
...
%                       figure(2), imshow(I);
                        pathName = 'C:\Users\Admin\Desktop\KLTN\KLTN2021\DataTraining\';
            ...
            elseif j==1
                if imageMouthDetect(1,2) > x/2
                    if imageMouthDetect(1,2) < 0.65*x
                        ...
                        I  = imresize(I,imageSize)
%                       figure(2),imshow(I);
                        pathName = 'C:\Users\Admin\Desktop\KLTN\KLTN2021\DataTraining\Data\';
                        filename = [pathName num2str(bienDemDataTraining) '.jpg'];
                        imwrite(I,filename);
